...
export default async function AllBonusesPage() {
    const bonuses = await getBonuses('all', 'all');

    // Group by GEO
    const geoGroups = bonuses.reduce((acc: any, bonus) => {
