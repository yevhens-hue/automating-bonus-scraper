                ...
                <nav className="sticky top-0 z-[100] bg-[#0a0d1a]/95 backdrop-blur-md border-b border-white/5 shadow-2xl">
                    <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-1 text-xs font-bold">
                            <Link href="/all-bonuses" className="text-gray-400 hover:text-white hover:bg-white/5 transition-colors duration-200 px-3 py-2 rounded-lg">
                                📊 {t('all_bonuses')}
                            </Link>
                            <Link href="/holiday-bonuses" className="text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors duration-200 font-bold px-3 py-2 rounded-lg border border-red-500/20 ml-2">
                                🎁 {t('holiday_bonuses')}
                            </Link>
                            <Link href="/vip-bonuses" className="text-yellow-500 hover:text-yellow-400 hover:bg-yellow-500/10 transition-colors duration-200 font-bold px-3 py-2 rounded-lg border border-yellow-500/20 ml-2">
                                👑 {t('vip_bonuses')}
                            </Link>
                            <Link
                                href="/top-odds"
                                prefetch={false}
                                className="text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors duration-200 font-bold px-3 py-2 rounded-lg border border-cyan-500/20 ml-2 shadow-[0_0_10px_rgba(34,211,238,0.1)] hover:shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                            >
                                📈 {t('top_odds')}
                            </Link>
                            <Link href="/blog" className="text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 transition-colors duration-200 px-3 py-2 rounded-lg border border-blue-500/20 ml-2">
                                ✍️ {t('blog')}
                            </Link>
                        </div>
                ...
                <footer className="relative z-10 py-16 px-4 border-t border-white/5 text-center bg-[#0a0d1a]">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex justify-center flex-wrap gap-8 mb-12 text-gray-500 font-bold uppercase tracking-widest text-[10px]">
                            <Link href="/all-bonuses" className="hover:text-white transition-colors">{t('all_bonuses')}</Link>
                            <Link href="/blog" className="hover:text-white transition-colors">{t('blog')}</Link>
                            <Link href="/holiday-bonuses" className="hover:text-white transition-colors">{t('holiday_bonuses')}</Link>
                            <Link href="/vip-bonuses" className="hover:text-white transition-colors">{t('vip_bonuses')}</Link>
                        </div>
